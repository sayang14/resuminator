...
const PublicationHints: SectionHints = {
  ...
  content: [{ type: "p", 
              body: "Having publications proves your experience, knowledge on a particular area. It also shows your good analytical and writing skills." 
            },
            {
              type: "p",
              body: "You can add any research paper that you have completed along any other authors who have also done the research and have worked with you."
            },
            {
              type: "p",
